...
import com.dwq.utils.FlowUtils;
...
public class AccountServiceImpl extends ServiceImpl<AccountMapper, Account> implements AccountService {
     ...
     * @return 操作结果，null表示正常，否则为错误原因
     */
    public String registerEmailAccount(EmailRegisterVO info, String role){
        ...
        if(role.equals("admin"))
            account= new Account(null, info.getUsername(),
                    password, email, Const.ROLE_ADMIN, new Date());
        else
            account= new Account(null, info.getUsername(),
    ...
    public boolean updateA(Account account){
      return   baseMapper.updateA(account);
    }
}
